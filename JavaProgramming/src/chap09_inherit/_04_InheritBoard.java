...
public class _04_InheritBoard {
	...
	public static void main(String[] args) {
		...
		NoticeBoard noticeBoard = new NoticeBoard(3, "공지사항게시판 제목", "공지사항게시판 내용", 
				"관리자", "231020", true);
...
//		board.upload("파일제목");
		...
		// board라는 변수 하나로 NoticeBoard의 insertBoard기능도
		//사용할 수 있다.
		board = new NoticeBoard(3, "공지사항게시판 제목", "공지사항게시판 내용", 
				"관리자", "231020", true);
