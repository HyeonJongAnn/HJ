...
public class FreeBoard extends Board{
	...
	//super로 부모의 생성자를 호출해주는 기능
	public FreeBoard(int boardNo, String boardTitle, String boardContent, 
			String boardWriter, String boardDate, String attachFile) {
	...
	// 3. 오버라이딩
	// 부모에 존재하는 기능을 자식에서 다른기능으로 만들어서 사용하는 것
