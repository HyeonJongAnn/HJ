...
public class _17_RockScissPaper {
	...
	public static void main(String[] args) {
		...
		int comRd2 = rd.nextInt(100); //0~99까지 랜덤하게 하나의 값을 선택
		int comRd3 = rd.nextInt(100) + 1; //1~100까지 랜덤하게 하나의 값을 선택
		
		//랜덤 값을 만드는 방법 2
		//Math클래스에 있는 random()메소드 이용
		//random() 메소드는 0~1사이의 실수를 랜덤하게 선택
		//double형으로 반환
		//0 <= comRd4 < 1
